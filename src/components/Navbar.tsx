            ...
            <div className="absolute right-0 top-full mt-2 w-64 rounded-xl border border-[#34444E] bg-[#1A282D] py-2 shadow-xl z-[100] origin-top-right animate-in fade-in zoom-in-95 duration-100">
               <div className="px-4 py-3 border-b border-[#34444E] flex items-center gap-3">
                  ...
                  <div className="flex flex-col text-left">
                     <p className="text-sm font-bold text-[#D7DADC]">Guest User</p>
                     <p className="text-xs text-[#82959B]">u/guest_user_99</p>
                  </div>
               </div>
               <ul className="py-2 flex flex-col text-[#D7DADC]">
                  <li>
                    <Link onClick={() => setIsDropdownOpen(false)} to="/user/guest_user_99" className="flex items-center px-4 py-2 hover:bg-[#2A3C42] transition text-sm font-semibold">
                  ...
                  <li>
                    <button onClick={() => setIsDropdownOpen(false)} className="w-full flex items-center px-4 py-2 hover:bg-[#2A3C42] transition text-sm font-semibold text-left">
                       <LogOut className="mr-3 h-5 w-5 text-[#82959B]"/> Log Out
                    </button>
                  </li>
               </ul>
            </div>
